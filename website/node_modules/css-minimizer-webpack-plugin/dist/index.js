...
class CssMinimizerPlugin {
  ...
  async optimize(compiler, compilation, assets, optimizeOptions) {
      ...
      scheduledTasks.push(async () => {
        ...
        if (!output) {
          ...
          try {
            ...
            compilation.errors.push(CssMinimizerPlugin.buildError(error, name, hasSourceMap ? new _sourceMap.SourceMapConsumer(inputSourceMap) : // eslint-disable-next-line no-undefined
          ...
          if (result.errors && result.errors.length > 0) {
            ...
            for (const error of result.errors) {
              output.warnings.push(CssMinimizerPlugin.buildError(error, name, hasSourceMap ? new _sourceMap.SourceMapConsumer(inputSourceMap) : // eslint-disable-next-line no-undefined
              undefined, // eslint-disable-next-line no-undefined
              hasSourceMap ? compilation.requestShortener : undefined));
            }
          }
          ...
          if (result.warnings && result.warnings.length > 0) {
            ...
            for (const warning of result.warnings) {
              const buildWarning = CssMinimizerPlugin.buildWarning(warning, name, hasSourceMap ? new _sourceMap.SourceMapConsumer(inputSourceMap) : // eslint-disable-next-line no-undefined
              undefined, // eslint-disable-next-line no-undefined
              hasSourceMap ? compilation.requestShortener : undefined, this.options.warningsFilter);
    ...
    const limit = getWorker && numberOfAssetsForMinify > 0 ? numberOfWorkers : scheduledTasks.length;
