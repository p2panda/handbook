...
- p2panda is at its core a definition of data schemas which can be distributed and interpreted by any kind of client which follows this definition. However, the use, interface and purpose on how p2panda is used is not further defined, which gives some freedom in what a client actually could be. Examples:
...
p2panda consists of two components, which may run on the same or on different computers
